...
def run_friendship_calculator():
    print("💙 Friendship Compatibilty Calculator 💙")
    name1 = input("Enter first name: ")
    name2 = input("Enter second name: ")
    score = friendship_score(name1, name2)

    if score > 80:
        print(f"\n {score}: You are like chai and samosa - Made for each other 💙")
    elif score > 50 and score <= 80:
        print(f"\n {score}: You are a good companion - You might gel together")
    else:
        print(f"\n {score}: Well... opposites attract, maybe?")
